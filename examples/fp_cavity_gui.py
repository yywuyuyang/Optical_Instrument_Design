...
class FPCavityGUI:
    ...
    def setup_ui(self):
        ...
        self.R_list_entry.pack(fill=tk.X, pady=(3, 3))
        ...
        desc_frame = ttk.LabelFrame(left_panel, text="图像说明", padding="8")
        desc_frame.pack(fill=tk.BOTH, expand=True)

        desc_text = """标签页1: 不同R0的透射率曲线
显示不同反射率下的透射率光谱
...
可见光/窄带/近红外透射特性"""
        ...
        desc_label = ttk.Label(desc_frame, text=desc_text, justify=tk.LEFT,
                               wraplength=270, font=("Microsoft YaHei", 9))
        ...
        for name in tab_names:
            ...
            self.canvases[name] = FigureCanvasTkAgg(self.figures[name], master=tab_frame)
